        ...
        <div class="card">
                ...
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('backoffice.paquete.create') }}">Crear Paquetes</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div class="body">               
                @if ($paquetes->isNotEmpty())                    
                    @include('models.paquete.content-index')
                @else
